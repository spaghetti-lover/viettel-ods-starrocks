...
CREATE TABLE IF NOT EXISTS categories (
	...
	category_id integer,
	-- to create parent/childe relationship (self-join)
...
CREATE TABLE IF NOT EXISTS orders (
	...
	-- The user ID of the order registerer
	address_id integer NOT NULL,
	order_amount decimal(15, 2) NOT NULL,
	-- Order amount without calculating tax and discount
	discount_amount decimal(15, 2) NOT NULL,
	tax_amount decimal(15, 2) NOT NULL,
	total_amount decimal(15, 2) NOT NULL,
	-- Order amount after subtraction of discount and tax
	discount_id integer,
...
INSERT INTO roles (role_name, role_title)
VALUES ('admin', 'Administrator') ON CONFLICT DO NOTHING;
INSERT INTO roles (role_name, role_title)
VALUES ('staff', 'Staff') ON CONFLICT DO NOTHING;
INSERT INTO roles (role_name, role_title)
VALUES ('manager', 'Manager') ON CONFLICT DO NOTHING;
INSERT INTO roles (role_name, role_title)
VALUES ('customer', 'Customer') ON CONFLICT DO NOTHING;
-- insert default value for 'ShippingStatus' table
INSERT INTO shippingstatus (shipping_status_name)
VALUES ('Pending') ON CONFLICT DO NOTHING;
INSERT INTO shippingstatus (shipping_status_name)
VALUES ('In Transit') ON CONFLICT DO NOTHING;
INSERT INTO shippingstatus (shipping_status_name)
VALUES ('Out for Delivery') ON CONFLICT DO NOTHING;
INSERT INTO shippingstatus (shipping_status_name)
VALUES ('Delivered') ON CONFLICT DO NOTHING;
INSERT INTO shippingstatus (shipping_status_name)
VALUES ('Failed Attempt') ON CONFLICT DO NOTHING;
INSERT INTO shippingstatus (shipping_status_name)
VALUES ('Returned') ON CONFLICT DO NOTHING;
-- insert default value for 'ShippingMethods' table
INSERT INTO shippingmethods (shipping_method_name)
VALUES ('Standard Shipping') ON CONFLICT DO NOTHING;
INSERT INTO shippingmethods (shipping_method_name)
VALUES ('Express Shipping') ON CONFLICT DO NOTHING;
INSERT INTO shippingmethods (shipping_method_name)
VALUES ('Next-Day Delivery') ON CONFLICT DO NOTHING;
INSERT INTO shippingmethods (shipping_method_name)
VALUES ('Free Shipping') ON CONFLICT DO NOTHING;
INSERT INTO shippingmethods (shipping_method_name)
VALUES ('Pickup from Store') ON CONFLICT DO NOTHING;
...
INSERT INTO orderstatus (order_status_name)
VALUES ('Shipped') ON CONFLICT DO NOTHING;
INSERT INTO orderstatus (order_status_name)
VALUES ('Delivered') ON CONFLICT DO NOTHING;
INSERT INTO orderstatus (order_status_name)
VALUES ('Cancelled') ON CONFLICT DO NOTHING;
-- insert default value for 'PaymentStatus' table
INSERT INTO paymentstatus (payment_status_name)
VALUES ('Pending') ON CONFLICT DO NOTHING;
INSERT INTO paymentstatus (payment_status_name)
VALUES ('Authorized') ON CONFLICT DO NOTHING;
INSERT INTO paymentstatus (payment_status_name)
VALUES ('Completed') ON CONFLICT DO NOTHING;
INSERT INTO paymentstatus (payment_status_name)
VALUES ('Failed') ON CONFLICT DO NOTHING;
INSERT INTO paymentstatus (payment_status_name)
VALUES ('Refunded') ON CONFLICT DO NOTHING;
-- insert default value for 'PaymentMethods' table
INSERT INTO paymentmethods (payment_method_name)
VALUES ('Credit Card') ON CONFLICT DO NOTHING;
INSERT INTO paymentmethods (payment_method_name)
VALUES ('Debit Card') ON CONFLICT DO NOTHING;
INSERT INTO paymentmethods (payment_method_name)
VALUES ('PayPal') ON CONFLICT DO NOTHING;
INSERT INTO paymentmethods (payment_method_name)
VALUES ('Bank Transfer') ON CONFLICT DO NOTHING;
INSERT INTO paymentmethods (payment_method_name)
VALUES ('Cash on Delivery') ON CONFLICT DO NOTHING;